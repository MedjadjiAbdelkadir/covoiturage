   ...
   <div class="container">
       <div class="row">
           @if(Session::has('error'))
               <div class="alert alert-danger alert-dismissible col-sm-12 col-md-7 text-center">
                   <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                   {{Session::get('error')}}
               </div>
           @endif
           @if(Session::has('success'))
               <div class="alert alert-success alert-dismissible col-sm-12 col-md-7 text-center">
                   <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                   {{Session::get('success')}}
               </div>
            @endif
               ...
               <div class="card p-2" style="border-radius: 9px">
                   ...
                   <div class="user-block row pl-1 pt-2 mb-2">
                       <div class="col-md-9 col-sm-12">
                           <img class="img-circle img-bordered-sm" src="{{asset('images/users/userProfile/'.$posts->users->avatar)}}" alt="User Image">
