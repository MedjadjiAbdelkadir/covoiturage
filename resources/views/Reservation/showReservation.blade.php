    ...
    <div class="container">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('MesReservation')}}">Mes Reservation</a></li>
        ...
        <div class="card mb-5">
            <div class="card-header mb-2">
                <h3 class="card-title">Show Details Reservation</h3>
            </div>
        <!-- /.card-header -->
            <div class="card-body p-0 pl-1 pr-2 row mb-4" style="min-height: 100px;">


                <div class="input-group col-12 pt-2 pb-2 col-md-4 col-sm-12">
                ...
                <div class="input-group col-12 pt-2 pb-2 col-md-4 col-sm-12">
                    ...
                    <h1 class="form-control">
                        ...
                        {{$data->date_départ}} a {{$data->time_départ}}
                    </h1>
                </div>
                <div class="input-group col-12 pt-2 pb-2 col-md-4 col-sm-12">
                    <div class="input-group-prepend col-5">
